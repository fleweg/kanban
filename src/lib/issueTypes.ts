import { BookOpen, Bug, Crown, Square, type LucideIcon } from "lucide-react";
...
export const EPIC_TYPE: IssueType = "epic";

export function getIssueType(id: IssueType | null | undefined): IssueTypeDef {
  return ISSUE_TYPES.find((t) => t.id === id) ?? ISSUE_TYPES[0];
}

export function isEpic(ticket: Pick<Ticket, "type"> | null | undefined): boolean {
